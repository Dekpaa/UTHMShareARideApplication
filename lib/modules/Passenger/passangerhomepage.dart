...
import 'package:uthmshareride/modules/SearchRides/searchride.dart';
...
class _PassengerHomepageState extends State<PassengerHomepage> {
  ...
  Widget _getPage(int index) {
    switch (index) {
      ...
      case 2:
        return const ListChatPassengerPage();
      default:
        return _buildHomeContent();
    }
  }
    ...
    return Scaffold(
      ...
      floatingActionButton: _selectedIndex == 0
          ? FloatingActionButton.extended(
              ...
              label: const Text("Search a Ride"),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 10),
          const Text(
            "Make sure your location is accurate before booking a ride.",
